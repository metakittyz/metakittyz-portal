...
export const SCENES = [
  {
    ...
    draw: matter,
    hold: 8,
    line: "Atomic particles vibrate at particular frequencies.",
    note: "Every atom in you is moving right now. It has never once stopped.",
    // A time that shows the scene at its best when it has to hold still.
    still: 3.1,
  },
  {
    id: "light",
    draw: light,
    hold: 9,
    line: "Just as light waves do.",
    note: "Red and blue are the same thing at different rates. Frequency isn't abstract — it's the colour you're looking at.",
    still: 2.4,
  },
  {
    id: "ocean",
    draw: ocean,
    hold: 8,
    line: "Ocean waves have frequencies.",
    note: "A swell looks complicated. It's simple waves added together — three of them, here.",
    still: 4.2,
  },
  {
    id: "heart",
    draw: heartbeat,
    hold: 8,
    line: "There's even a rhythm of our heartbeats.",
    note: "Roughly one hertz. You've been keeping this time since before you were born.",
    still: 1.6,
  },
  {
    id: "everything",
    draw: everything,
    hold: 8,
    line: "Everything is a sea of vibration in motion.",
    note: "Matter, light, water, blood. Not similar to waves. Waves.",
    still: 3.4,
  },
  {
    id: "resonance",
    draw: resonanceScene,
    hold: 10,
    line: "So it's only natural that we, as spiritual beings, can connect with other frequencies.",
    note: "Two waves that disagree cancel to nothing. The same two, in phase, come to twice the height. Connection isn't proximity. It's agreement.",
    still: 6.5,
  },
  {
    id: "senses",
    ...
    note: "Sonia Choquette's line, from Ask Your Guides. The universe issues every creature an instrument for the thing it cannot otherwise perceive. The bat is shouting at 80 kHz — louder than a smoke alarm, and you have never heard it once.",
    source: "Sonia Choquette · Ask Your Guides",
    // The app labels its claims everywhere else; it doesn't get to stop here.
    footnote:
      "One correction, offered in the same spirit: birds don't use radar. They read Earth's magnetic field, and the angle it dips into the ground tells them their latitude. Stranger than radar, and measurable. Bats really do use sonar.",
    still: 5.5,
  },
  {
    id: "recognition",
    draw: recognition,
    hold: 11,
    line: "If we recognise ourselves as spirit, we can more easily recognise the inhabitants of the nonphysical world as well.",
    note: "The faint ones were always there. They come up out of the dark as you tune — not because they arrived, but because you can finally hear them.",
    still: 7,
  },
  {
    id: "flow",
    draw: flow,
    hold: 14,
    line: "Awaken the sixth sense, connect with your guides, and life falls into a pattern of ease and flow.",
    note: "You grow your soul, you get on with what you came for, and — Choquette's word, and the best one — your time here becomes endlessly entertaining. Twelve oscillators, each at its own rate. Scattered, they cancel each other down to under half their possible height. In step, they reach all of it. Nothing was added when they locked — they just stopped subtracting from one another.",
    source: "Sonia Choquette · Ask Your Guides",
    still: 12,
  },
];
